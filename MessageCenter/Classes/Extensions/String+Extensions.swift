...
extension String {
    ...
    var localized : String {
        get{
            let frameworkBundle = Bundle.bundleForXib(GroupChannelChattingViewController.self)
                
                //Bundle(for: MessageCenter.self)
            return NSLocalizedString(self, tableName: "MessageCenter", bundle: frameworkBundle!, value: "", comment: "")
        }
    }
    
    static func locationURL(strLocation: String) -> URL? {
