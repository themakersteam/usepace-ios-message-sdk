...
class SelectLocationViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        CommonUtils.showErrorAlertController(vc: self, title: "send_location.title", message: "send_location.location_disabled_notice.message")
...
//        let locationUri = "\(finalCoordinates.latitude),\(finalCoordinates.longitude)"
    ...
    private func switchSendButtonState() {
        ...
        if hasDroppedPin {
            ...
            sendLocationIcon.image = UIImage(named: "icredpin", in: Bundle.bundleForXib(SelectLocationViewController.self), compatibleWith: nil)
        }
        else  {
            sendLocationBtn.setTitle("send_location.send_button.case_my_location.title".localized, for: .normal)
            sendLocationIcon.image = UIImage(named: "sendlocation", in: Bundle.bundleForXib(SelectLocationViewController.self), compatibleWith: nil)
        } 
    }
    private func setRegionToMyLocation(){
        ...
        self.currentUserLocationRegion = MKCoordinateRegion(center: loc.coordinate, span: span)
