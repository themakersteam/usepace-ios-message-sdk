...
class IncomingGeneralUrlPreviewMessageTableViewCell: UITableViewCell {
...
//    @IBOutlet weak var messageLabel: TTTAttributedLabel!
    ...
    func setModel(aMessage: SBDUserMessage) {
        ...
        urlTextView.attributedText = fullMessage
...
extension IncomingGeneralUrlPreviewMessageTableViewCell : UITextViewDelegate {
